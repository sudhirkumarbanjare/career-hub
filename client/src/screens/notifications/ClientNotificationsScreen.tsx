...
export interface ClientNotificationsScreenProps {
  onBack: () => void;
  onOpenNotification?: (deepLink?: string) => void;
}

export const ClientNotificationsScreen: React.FC<ClientNotificationsScreenProps> = ({
  onBack,
  onOpenNotification,
}) => {
  ...
  const handleMarkAllRead = () => {
    ClientService.markAllNotificationsAsRead();
    setNotifications([...ClientService.getNotifications()]);
  };

  const handlePressNotification = (notif: AppNotification) => {
    ClientService.markNotificationRead(notif.id);
    setNotifications([...ClientService.getNotifications()]);
  ...
  const handleDeleteNotification = (id: string) => {
    ClientService.deleteNotification(id);
    setNotifications([...ClientService.getNotifications()]);
  };
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySub}>
              {filter === 'unread'
                ? 'You have read all employer alerts and updates.'
          ...
          >
            <Card style={[styles.notifCard, !item.read ? styles.unreadCard : null]}>
              ...
              <View style={styles.cardFooter}>
                {item.deepLink ? (
                  <Text style={styles.tapText}>Open applications →</Text>
                ) : (
                  <View />
                )}
                <TouchableOpacity
